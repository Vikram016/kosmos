...
modalText.innerHTML = `
       <div style="position:relative;padding:0;background:#fff;border-radius:8px;max-width:600px;margin:40px auto;max-height:600px;overflow:hidden;">
            ...
            span
	    {
          ...
          <div class="nav-links">
            <button id="topics-toggle">Techno systems - Topics &#9660;</button>
            <div id="topics-links">
	     ...
	     presented in the "Social system" chapter on this website.
           </p>
	   ...
	   <p>
	     ...
	     Andalusian, Rajasthani, Mughal, African, Russian and West Asian. For passive and active environment control, depending on the kosmik world, 
        ...
        if (toggleBtn && linksDiv) {
          toggleBtn.addEventListener('click', function() {
            if (linksDiv.style.display === 'none' || linksDiv.style.display === '') {
              ...
              toggleBtn.innerHTML = 'Techno systems - Topics &#9650;';
            } else {
...
modalText.innerHTML = `
       <div style="position:relative;padding:0;background:#fff;border-radius:8px;max-width:600px;margin:40px auto;max-height:600px;overflow:hidden;">
            ...
            span
	    {
         ...
         <div class="nav-links">
            <button id="topics-toggle">Social system - Topics &#9660;</button>
            <div id="topics-links">
	 ...
	 National boundaries are artificial but human fraternity is natural.
	   ...
	   <p style="margin-left:1em; margin-bottom:10px";>
	     ...
	     of Ashoka came about because he was the progeny of a grandmother who had married at the modern "Magic adult age 18" or 38.
           ...
           <p style="margin-left:1em; margin-bottom:10px";>
	     So about age, in the context of this chapter being about removal of feudalism from kosmos travel, it is not as if Kosmos / Nature will throw back to Earth 
	    ...
	    This section is about language, appearance and personality of the kosmonauts.
	     ...
	     each of the people involved in the cooperatives should be participants in 
           ...
           <p>
             ...
             Please read the section about Serf satellite in the "Techno systems" chapter on this website.
           </p>
	   ...
	   <p>
	     ...
	     cities should not be, how humans should not be. This is the sole good thing about these cities.
           ...
           <p>
             The cities redesigned by us, Kosmos Society, will have beauty in every sense coming from ten things :
           </p>
	     ...
	     This in turn means adopting the Workers Cooperative work model in all aspects of life. This means that there will be no class system in these cities.
	   </p>
	     ...
	     Andalusian, Rajasthani, Mughal, African, Russian and West Asian. For passive and active environment control, the features must include windcatchers, 
	     ...
	     two storeys and every building must be safe for human and cat. Every public building and private house must have comfy housing for cats 
	     ...
	     also double as provision stores.
	   </p>
	     ...
	     assign this work to a "low class" people aka "kamzaat log" aka "kamjaat log" who have done this dangerous work for a hundred generation and 
	     die in the drains of the middle class neighborhoods because of being suffocated by methane gas, by lack of oxygen, by drowning in sewage and 
	     ...
	     festivals, by doing regular pilgrimages... these people don't see the immorality of not cleaning their own drains but imposing this work 
	     on multi-generational "kamzaat log" who die in the drains yearly. This is genocide. So what is it that the super-pious middle class peepz in South Asia 
	     learn from their 365-days-a-year religious posturing ? The middle class itself is a slave class for the rich yet the middle class do not empathize with 
	     those poorer than them but instead impose cruelty upon the poorer like sanitation workers. The middle class people are just enforcers of the feudals...  
	     of the millenia-long feudal system, despite the middle class claiming to be educated people. Therefore in the classless cities we of Kosmos Society 
	     will design, the former middle class peepz of South Asia will learn to become human.
	   </p>
	     ...
	     chicken egg, sheep milk and honey. For the three four foods there should be farms which are kind to the relevant animals yet beneficial for humans 
	     ...
	     our Moggy robot cats who replicate the reflexes of cats.
           ...
           <p style="margin-left:1em; margin-bottom:10px";> 
             <span>(j).</span> 
	     Gentleness in cities also from removing public prayer houses. Belief in God is a personal aspect in the believes and the public veneration 
	  ...
	  <p>
	    ...
	    the nutritious originally animal products like given in the "Biology researches" section above. These techno-social food productions must be done in 
	    decentralized, neighborhood-level indoor farms which have localized water generation as much as possible as well as scientifically built canals. 
      ...
      setTimeout(function() {
        ...
        if (toggleBtn && linksDiv) {
          toggleBtn.addEventListener('click', function() {
            if (linksDiv.style.display === 'none' || linksDiv.style.display === '') {
              linksDiv.style.display = 'flex';
              toggleBtn.innerHTML = 'Social system - Topics &#9650;';
            } else {
              linksDiv.style.display = 'none';
              toggleBtn.innerHTML = 'Social system - Topics &#9660;';
            }
...
modalText.innerHTML = `
	...
	<p><p><span>&gt;&gt;</span> 
	  ...
	  not a subordinate to some feudal boss. Please read the "Social organization for kosmonauts" section in the "Social system" chapter and 
	...
	<p><p><span>&gt;&gt;</span> 
	  You will be at the front of progressive evolution of humanity, both social and technological.
	     ...
	     to their citizens without tax. This way the kosmos will become accessible to potentially every human.
	   </p>
