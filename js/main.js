	 ...
	 National boundaries are artificial but human fraternity is natural.
	   ...
	   <p>
	    ...
	    This topic is about language, appearance and personality of the kosmonauts.
	     ...
	     The men in particular have to be gentlemen who are honest, are well groomed and well dressed, genuine in speech, speak their mind but with decency, 
	     support the correct ( like ceding place in a queue for an elderly person ) and not support the incorrect vocally ( like telling a queue breaker ), 
	     do no anti-social behavior ( like urinating in public places ) and are collaborative instead of competitive.
           </p>
	     ...
	     from intake of "spice" comes from two things :
           ...
           <p style="margin-left:1em; margin-bottom:10px";> 
             <span>(a).</span> Blue eyes found within the Imohag people.
	   </p>
	   ...
	   <p>
	     ...
	     https://sharjahevents.ae/en/event/tinariwen-live-in-sharjah/
           ...
           <p>
	     About women's dress and presentation, women should not appear fake or unfeminine or remind of oppressive traditional elements. 
	     Recommendations include not using or doing the following items :
           </p>
	   ...
	   <p style="margin-left:1em; margin-bottom:10px";>
	     <span> >> </span> Aggressive language and foul words in order to pretend to be "one of the boys".
           </p>
	   ...
	   <p style="margin-left:1em; margin-bottom:10px";>
	     <span> >> </span> Too much jewlery and gaudy jewelry.
           </p>
