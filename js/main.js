    ...
    if (chapter === 'constitution') {
      modalText.innerHTML = `
        <div style="position:relative;padding:2em 2em 1em 2em;background:#222;border-radius:8px;max-width:600px;margin:40px auto;max-height:400px;overflow:auto;scrollbar-width:thin;scrollbar-color:#fff #222;font-family:Roboto,sans-serif;">
          ...
          <h2 style="color:#fff; margin-bottom:10px;"margin-bottom:10px;"text-align:center;margin-bottom:10px;"> Our draft constitution for Space :</h2>
      ...
      modalText.innerHTML = `
        <div style="position:relative;padding:2em 2em 1em 2em;background:#222;border-radius:8px;max-width:600px;margin:40px auto;max-height:400px;overflow:auto;scrollbar-width:thin;scrollbar-color:#fff #222;">
          ...
          <h2 style="color:#fff; margin-bottom:10px;"margin-bottom:10px;"text-align:center;margin-bottom:10px;">Our progressive product design principles</h2>
          <div style="color:##FFFFc5;font-size:1.1em;">
      ...
      modalText.innerHTML = `
        ...
        .minimal-tag:hover {
          ...
          <h2 style="color:#fff; margin-bottom:10px;"margin-bottom:10px;"text-align:center;margin-bottom:10px;">Join us :</h2>
          <div style="color:#FFFFc5;font-size:1.1em;">
      ...
      modalText.innerHTML = `
        <div style="position:relative;padding:2em 2em 1em 2em;background:#222;border-radius:8px;max-width:600px;margin:40px auto;max-height:400px;overflow:auto;scrollbar-width:thin;scrollbar-color:#fff #222;">
          ...
          <h2 style="color:#fff; margin-bottom:10px;"margin-bottom:10px;"text-align:center;margin-bottom:10px;">Credits</h2>
          <div style="color:#FFFFc5;font-size:1.1em;">
            ...
            <p style='margin-bottom:10px;'><span>&gt;&gt;</span> Vishal Bhimrao Zuluk Saraswati for the idea about doing computation using sound.</p>
            ...
            <p style='margin-bottom:10px;'><span>&gt;&gt;</span> Planetary Science Division of NASA for the idea of creating an artificial magnetosphere
             ...
             discussed with her uncle Vishal Bhimrao Zuluk Saraswati who conveyed this to Mohammed Sameer, 
             and Vishal and Sameer had a substantial discussion on this and this discussed resulted in 
             "exoskeletons" becoming part of Kosmos Society's designs.</p>
      ...
      modalText.innerHTML = `
        <div style="position:relative;padding:2em 2em 1em 2em;background:#222;border-radius:8px;max-width:600px;margin:40px auto;max-height:400px;overflow:auto;scrollbar-width:thin;scrollbar-color:#fff #222;">
          ...
          <div style="color:#FFFFc5;font-size:1.1em;">
            <h2 style="color:#fff; margin-bottom:10px;"margin-bottom:10px;"margin-bottom:10px;text-align:center;">Faradn electricity generator</h2>
      ...
      modalText.innerHTML = `
        ...
        @media (min-width: 1200px) {
          ...
          <h2 style="color:#fff; margin-bottom:10px; text-align:center;margin-bottom:10px;">Contact Us</h2>
          <div style="color:#FFFFc5;font-size:1.1em;">
