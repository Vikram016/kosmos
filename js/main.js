...
modalText.innerHTML = `
	   ...
	   <p style="margin-left:1em; margin-bottom:10px";>
	     ...
	     or for kosmonauts to belong to only certain Earthen countries their governments like, and so on. The kosmos belongs to all humans 
             as long as they respect Nature and Nature's laws and are not cruel and apathetic to others. The concept of tax is a feudalist idea 
	     which existed during the times of kings and colonizers ( like the British colonials in India ) who had officials called Collectors to collect tax even from 
	     a peasant who earned 100 dollars per year while the feudal earned 100,000 dollars every month and only misery came free to the peasant while 
	     the feudal earned his 100,000 dollars every month by profiting off the misery of the peasant including by doing usury to the peasant who in turn 
	     burdened every month by usury hanged himself from a tree in the village or jumped into the village lake. So, no person who claims to believe in Democracy  	       can demand tax and those who do must reflect.
           </p>
